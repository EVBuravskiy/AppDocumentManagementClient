    ...
    public class DocumentViewModel : BaseViewModelClass
    {
        ...
        public DocumentViewModel(DocumentWindow window, ExternalDocument selectedDocument)
        {
            ...
            if (SelectedDocument != null)
            {
                ...
                EmployeeReceivedDocument = SelectedDocument.ReceivingEmployee;
        ...
        private void GetDocumentFiles()
        {
            if(SelectedDocument != null)
            {
                ...
                DocumentFilesList = externalDocumentFileService.GetExternalDocumentFiles(SelectedDocument.ExternalDocumentID).Result;
            }
        }
        ...
        private void DeleteDocumentFile()
        {
            ...
            if (SelectedDocument != null)
            {
                ...
                {
                    ExternalDocumentFileService externalDocumentFileService = new ExternalDocumentFileService();
                    result = externalDocumentFileService.RemoveExternalDocumentFile(SelectedDocumentFile.ExternalDocumentFileID).Result;
                }
                if (result)
                {
        ...
        private void UpdateDocument()
        {
            ...
            if(SelectedDocument.ReceivingEmployee == null || SelectedDocument.ReceivingEmployee != EmployeeReceivedDocument)
            {
                ...
                SelectedDocument.ExternalDocumentSendingDate = DateTime.Now;
            }
            bool result = false;
            ExternalDocumentsService externalDocumentsService = new ExternalDocumentsService();
            result = externalDocumentsService.UpdateExternalDocument(SelectedDocument).Result;
            if (result)
            {
        ...
        private void RemoveDocument()
        {
            ...
            {
                ExternalDocumentsService externalDocumentsService = new ExternalDocumentsService();
                externalDocumentsService.RemoveExternalDocument(SelectedDocument.ExternalDocumentID);
            }
            DocumentWindow.Close();
        }
        ...
        private void SendToExaminingPerson()
        {
            ...
            if (examiningPersonsWindow.viewModel.SelectedEmployee != null)
            {
                ...
                {
                    document.ExternalDocumentSendingDate = DateTime.Now;
                    result = externalDocumentsService.UpdateExternalDocument(document).Result;
                }
            }
            if (result)
            {
