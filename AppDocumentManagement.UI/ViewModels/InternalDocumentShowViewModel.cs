...
namespace AppDocumentManagement.UI.ViewModels
{
    public class InternalDocumentShowViewModel : BaseViewModelClass
    {
        ...
        private Employee GetEmployeeByID(int employeeID)
        {
            ...
            Employee employee = employesService.GetEmployeeByID(employeeID).Result;
        ...
        private void BrowseInternalDocumentFile()
        {
            ...
            InternalDocumentFileService internalDocumentFileService = new InternalDocumentFileService();
            bool result = internalDocumentFileService.AddInternalDocumentFile(internalDocumentFile).Result;
            if (result)
            {
