...
namespace AppDocumentManagement.UI.ViewModels
{
    public class EmployeeViewModel : BaseViewModelClass
    {
        ...
        private void InitializeDepartments()
        {
            ...
            DepartmentList = departmentService.GetAllDepartments().Result;
        ...
        private void GetEmployeePhotoPath()
        {
            ...
            EmployeePhoto employeePhoto = employeePhotoService.GetEmployeePhotoByEmployeeID(employee.EmployeeID).Result;
        ...
        private void Remove()
        {
            if (employee != null)
            {
                ...
                bool result = employesService.RemoveEmployee(employee.EmployeeID).Result;
                if (result)
                {
        ...
        private void Save()
        {
            ...
            if (employee == null)
            {
                List<Employee> aviableEmployees = employesService.GetAllEmployees().Result;
                var aviableEmployee = aviableEmployees.SingleOrDefault(e => e.EmployeeFullName == newEmployee.EmployeeFullName);
            ...
            {
                List<Employee> employees = employesService.GetEmployeesByDepartmentID(newEmployee.DepartmentID).Result;
                Employee currentEmployee = employees.SingleOrDefault(e => e.EmployeeRole == SelectedEmployeeRole);
            ...
            {
                employesService.AddEmployee(newEmployee);
            }
            else
            {
