...
namespace AppDocumentManagement.UI.ViewModels
{
    public class ProductionTaskViewModel : BaseViewModelClass
    {
        ...
        public ProductionTaskViewModel(ProductionTaskWindow window, Employee currentEmployee, ExternalDocument externalDocument, InternalDocument internalDocument)
        {
            ...
            Department department = departmentService.GetDepartmentByID(currentEmployee.DepartmentID).Result;
        ...
        private void AddNewTask()
        {
            ...
            bool result = productionTasksService.AddProductionTask(productionTask).Result;
            if (result)
            {
