...
namespace AppDocumentManagement.UI.ViewModels
{
    public class ManagerPanelViewModel : BaseViewModelClass
    {
        ...
        private void GetExternalDocuments()
        {
            ...
            if (ExternalDocumentsList.Count > 0)
            {
                ...
                foreach (ExternalDocument document in ExternalDocumentsList)
                {
                    ...
                    if (employee != null) document.ReceivingEmployee = employee;
                }
            }
        }
        ...
        private void GetInternalDocuments() 
        {
            ...
            InternalDocumentsList = internalDocumentsService.GetInternalDocumentsByEmployeeRecievedDocumentID(currentUser.EmployeeID).Result;
